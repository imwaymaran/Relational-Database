...
## Implementation
Original instructions require the code implementation with Bash scripting language. [There](python_implementation) you can find my implementation of the project in Python.
